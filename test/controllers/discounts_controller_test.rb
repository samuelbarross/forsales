...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { description: @discount.description, kind: @discount.kind, name: @discount.name, status: @discount.status, user_id: @discount.user_id, value: @discount.value } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { description: @discount.description, kind: @discount.kind, name: @discount.name, status: @discount.status, user_id: @discount.user_id, value: @discount.value } }
